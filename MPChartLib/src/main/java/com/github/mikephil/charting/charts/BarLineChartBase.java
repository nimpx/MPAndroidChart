...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mAxisRendererLeft.setHilightIndices(mIndicesToHighlight);
        mAxisRendererLeft.renderHighlightLine(canvas);
        ...
        mXAxisRenderer.setHilightIndices(mIndicesToHighlight);
